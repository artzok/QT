...
public:
    ...
    void setupUi(QDialog *SortDialog)
    {
        ...
        teriaryColumnCombo = new QComboBox(tertiaryGroupBox);
        teriaryColumnCombo->setObjectName(QStringLiteral("teriaryColumnCombo"));

        gridLayout_3->addWidget(teriaryColumnCombo, 0, 1, 1, 1);
        ...
        QWidget::setTabOrder(comboBox_4, teriaryColumnCombo);
        QWidget::setTabOrder(teriaryColumnCombo, comboBox_6);
    ...
    void retranslateUi(QDialog *SortDialog)
    {
        ...
        teriaryColumnCombo->insertItems(0, QStringList()
         << QApplication::translate("SortDialog", "None", 0)
        );
